...
public class InterruptExample {
    ...
    // 1.都是获取线程中断状态的方法
    // 2.interrupted() 调用后会清除当前线程的中断状态 isInterrupted() 不会清除
    private static void interruptTest() throws InterruptedException {
        ...
        Thread.sleep(100L);
        // interruptTest:false
        System.out.println("interruptTest2:" + thread.isInterrupted());
        thread.interrupt();
        Thread.sleep(100L);
        // interruptTest:false 阻塞状态中断位被捕获后会被自动清除
        System.out.println("interruptTest3:" + thread.isInterrupted());
    }
}
