  ...
  public void downloadFile() throws RestClientException {
    ...
    ResponseExtractor<File> extractor =
        response -> {
          ...
          try (ReadableByteChannel readableByteChannel = Channels.newChannel(response.getBody())) {
    ...
    // 2.
    File file1 = restTemplateWithoutEncode.execute(downloadUrl, HttpMethod.GET, null, extractor);
