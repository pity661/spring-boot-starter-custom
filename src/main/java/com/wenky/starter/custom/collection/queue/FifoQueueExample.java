...
public class FifoQueueExample {
  ...
  private static void getExample() throws InterruptedException {
    ...
    System.out.println(
        String.format("removeObjectResult: %s, queueSize: %d", removeObjectResult, queue.size()));
  ...
  private static void offerTimeoutExample(BlockingQueue<String> queue) throws InterruptedException {
    new Thread(
            () -> {
